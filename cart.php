...
if (isset($_POST['empty_cart'])) {
    ...
    $verify_empty_item->execute([$user_id]); // Assuming $user_id is defined elsewhere
...
<head>
    ...
    <title> Clothing Shop - Cart Page</title>
</head>
<body>
    ...
    <div class="main">
        ...
        <div class="title2">
            <a href="dashboard.php">Dashboard</a><span> /cart</span>
        </div>
